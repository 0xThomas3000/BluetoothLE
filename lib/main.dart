...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _sendData() async {
    await flutterReactiveBle.writeCharacteristicWithResponse(
        _rxCharacteristic as QualifiedCharacteristic,
        value: _dataToSendText?.text.codeUnits as List<int>);
  }
        ...
        case DeviceConnectionState.connected:
          {
            ...
            _receivedDataStream = flutterReactiveBle.subscribeToCharacteristic(
                _txCharacteristic as QualifiedCharacteristic);
